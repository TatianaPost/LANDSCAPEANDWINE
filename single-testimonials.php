<?php get_header(); ?>
	...
	<section class="content">
		<div class="wrapper">
			<div class="tcw-wrap ">
				<h1 class="content-title"><?php _e('Testimonial','aletheme'); ?></h1>
			...
			<div class="page-content cf">
				<div class="main-content left single-page">
					<div class="image">
						<?php if(get_the_post_thumbnail($post->ID,'testimonial-thumba')){
							echo get_the_post_thumbnail($post->ID,'testimonial-thumba');
						} else{
										...
										<ul class="slides">
											<?php foreach ( $attachments as $attachment ) { ?>
												<li data-thumb="<?php echo esc_url($attachment->guid); ?>">
													<?php echo wp_get_attachment_image( $attachment->ID, 'testimonial-big' ); ?>
												</li>
											<?php } ?>
										</ul>
									</div>
