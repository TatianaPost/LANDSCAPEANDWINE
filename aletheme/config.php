...
function aletheme_metaboxes($meta_boxes) {
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => 'Titulo slide',
				'desc' => 'Ingresar el subtitulo del tour',
				'id'   => $prefix . 'hd_txttitulo',
				'type' => 'text',
			),
			array(
				'name' => 'Subtitulo slide',
				'desc' => 'Ingresar el subtitulo del tour',
				'id'   => $prefix . 'hd_txtsubtitulo',
				'type' => 'text',
			),
			array(
				'name' => 'Descripción corta slide',
				'desc' => 'Ingesar descripción corta del tour',
				'id'   => $prefix . 'hd_txtcomplemento',
				'type' => 'textarea_code',
			),
			array(
				'name' => 'Precio',
				'desc' => 'Ingrese el precio sin el signo pesos',
				'id'   => $prefix . 'hd_price',
				'type' => 'text',
			),
			array(
				'name' => 'Detalle por persona',
				'desc' => 'Texto explictaivo del precio',
				'id'   => $prefix . 'hd_days',
				'type' => 'text',
			),
			array(
